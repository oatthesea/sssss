    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                nadya.sendMessage(op.param1, "HELLO {} :D".format(str(nadya.getContact(op.param1).displayName)))
        if op.type == 13:
...
#==============================================================================#
                    ...
                    time.sleep(5)
                    nadya.sendMessage(to, "Restart!")
                    restartBot()
                elif text.lower() == 'runtime':
                    timeNow = time.time()
                    runtime = timeNow - botStart
                    runtime = format_timespan(runtime)
                    nadya.sendMessage(to, "Bot {}".format(str(runtime)))
...
#==============================================================================#
                    ...
                    nadya.sendMessage(to, "Auto Add ON")
                elif text.lower() == 'autoadd off':
                    settings["autoAdd"] = False
                    nadya.sendMessage(to, "Auto Add OFF")
                elif text.lower() == 'autojoin on':
                    settings["autoJoin"] = True
                    nadya.sendMessage(to, "Auto Join ON")
                elif text.lower() == 'autojoin off':
                    settings["autoJoin"] = False
                    nadya.sendMessage(to, "Auto Join OFF")
                elif text.lower() == 'autoleave on':
                    settings["autoLeave"] = True
                    nadya.sendMessage(to, "Auto Leave ON")
                elif text.lower() == 'autojoin off':
                    settings["autoLeave"] = False
                    nadya.sendMessage(to, "Auto Leave OFF")
                elif text.lower() == 'autoread on':
                    settings["autoRead"] = True
                    nadya.sendMessage(to, "Auto Read ON")
                elif text.lower() == 'autoread off':
                    settings["autoRead"] = False
                    nadya.sendMessage(to, "Auto Read OFF")
                elif text.lower() == 'checksticker on':
                    settings["checkSticker"] = True
                    nadya.sendMessage(to, "Check Details Sticker ON")
                elif text.lower() == 'checksticker off':
                    settings["checkSticker"] = False
                    nadya.sendMessage(to, "Check Details Sticker OFF")
                elif text.lower() == 'detectmention on':
                    settings["datectMention"] = True
                    nadya.sendMessage(to, "Detect Mention ON")
                elif text.lower() == 'detectmention off':
                    settings["datectMention"] = False
                    nadya.sendMessage(to, "Detect Mention OFF")
                elif text.lower() == 'clonecontact':
                    settings["copy"] = True
                    nadya.sendMessage(to, "Copy")
#==============================================================================#
                elif text.lower() == 'me':
                    ...
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        ...
                        try:
                            ...
                            nadya.sendMessage(msg.to, "CLONE..")
                        except:
                            nadya.sendMessage(msg.to, "clone member")
                    ...
                    try:
                        ...
                        nadya.sendMessage(msg.to, "MOMENT..")
                    except:
                        nadya.sendMessage(msg.to, "restore profile")
...
#==============================================================================#
                    ...
                    if msg.toType == 2:
                        ...
                        if group.preventedJoinByTicket == False:
                            ...
                            nadya.sendMessage(to, "{}open qr".format(str(settings["keyCommand"])))
                elif text.lower() == 'groupticket on':
                    if msg.toType == 2:
                        group = nadya.getGroup(to)
                        if group.preventedJoinByTicket == False:
                            nadya.sendMessage(to, "fail")
                        else:
                            group.preventedJoinByTicket = False
                            nadya.updateGroup(group)
                            nadya.sendMessage(to, "grup qr")
                elif text.lower() == 'groupticket off':
                    if msg.toType == 2:
                        group = nadya.getGroup(to)
                        if group.preventedJoinByTicket == True:
                            nadya.sendMessage(to, "off qr")
                        else:
                            group.preventedJoinByTicket = True
                            nadya.updateGroup(group)
                            nadya.sendMessage(to, "group qr")
